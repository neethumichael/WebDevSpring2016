...
(function () {
    ...
    function ProjectService($rootScope) {
        ...
        var model = {
            projects: [
                {id: 567, title: "TWC", description: "Web development", status: "Closed",
                    projectTasks: [task1 , task2],  startDate: new Date(2013, 3, 3), endDate: new Date(2015, 3, 3)},
                {id: 987, title: "Shell", description: "ETL", status: "Open", project_id: "08",
        ...
        $rootScope.projects = model.projects;
        return model;
        ...
        function updateProject(project) {
            if (project) {
                model.projects[$rootScope.selectedProjectIndex] = {
                    title: project.title,
                ...
                return model.projects[$rootScope.selectedProjectIndex];
            }
            else {
                return null;
            }
        ...
        function selectProject(index) {
            $rootScope.selectedProjectIndex = index;
        ...
        function addProject(project) {
            if ($rootScope.selectedProjectIndex === null) {
                var newProject = {
                    id: (new Date).getTime(),
                    title: project.title,
                    description: project.description,
